CXXFLAGS=-c -std=c++11 -I lib -Wall
...
pmake.o: src/pmake.cpp src/pmake.hpp src/makefile_record.hpp src/file.hpp src/pmake_options.hpp src/main.hpp src/thread.hpp
